        ...
        3: [function(require, module, exports) {
            ...
            GIF = function(superClass) {
                ...
                GIF.prototype.addFrame = function(image, options) {
                    console.log('GIF addFrame');
                    var frame, key;
                    if (options == null) {
                        console.log('GIF addFrame: options were null');
                        options = {}
                    }
                    frame = {};
                    frame.transparent = this.options.transparent;
                    for (key in frameDefaults) {
                        console.log('GIF addFrame: key in frameDefaults:'+key);
                    ...
                    if (typeof ImageData !== "undefined" && ImageData !== null && image instanceof ImageData) {
                        console.log('GIF addFrame: typeof ImageData');
                        ...
                        console.log('GIF addFrame: typeof CanvasRenderingContext2D');
                        if (options.copy) {
                        ...
                        console.log('GIF addFrame: typeof image.childnode');
                        if (options.copy) {
                    ...
                    console.log("GIF addFrame: frame at end:");
                    console.dir(frame);
